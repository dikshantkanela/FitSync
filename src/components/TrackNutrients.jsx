  ...
  return (
    ...
    >
      ...
      <div className="right flex flex-col">
        ...
        <p className="text-gray-300 text-justify text-xl ml-2 h-[180px] w-[600px] mb-[-50px] mt-6">
        ...
        <Link
          to="/nutrients"
          className="flex items-center my-[157px] gap-2 px-3 w-[120px] py-2 rounded-md text-indigo-50 bg-[#114880] hover:bg-[#20346d] transition-colors"
        >
